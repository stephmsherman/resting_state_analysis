...
#cd /home3/kensinel/fMRI_DATA/SleepLDF/$scan\_resting_state/pipeline_REST/$sub/scrubbed_preprocessed/_scan_func_$sub\_$scan/_csf_threshold_0.96/_gm_threshold_0.7/_wm_threshold_0.96/_threshold_0.3/_compcor_ncomponents_5_selector_pc10.linear1.wm1.global1.motion1.quadratic1.gm0.compcor0.csf1/_bandpass_freqs_0.005.0.1

#output=$(fslval scrubbed_preprocessed.nii.gz dim4)
